...
public:
	...
	void run() {
		...
		std::cout << "Time taken to initialize API and upload triangle: " << elapsed.count() << " s\n";
...
private:
	...
	void createUniformBuffer() {
		...
		uniformBufferData.transformationMatrix = glm::mat4(1);
	...
	void createGraphicsPipeline() {
		VkShaderModule vertexShaderModule = createShaderModule("vert.spv");
		VkShaderModule fragmentShaderModule = createShaderModule("frag.spv");
